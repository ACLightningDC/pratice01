	...
	<div style="border: solid 1px black;">
			...
			<table  style="width:100%;text-align:center; border: solid 1px black ; margin-left:auto; margin-right:auto">
				<tr>
					...
					<div><input name= "id" type="text" id="id" id="id"size="40" placeholder="8-12자 영문과 문자조합을 입력하세요"/>
				...
				<tr>
					...
					<td>
					<div><input name= "password" type="text" id="name" placeholder="8-12자 영문과 문자조합을 입력하세요"/></div>
					</td>
				...
				<tr>
					...
					<td>
					<div><input name= "name" type="text" placeholder="한글 또는 영문만 입력하세요(특수문자 제외)"/></div>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<div><input name= "email" type="email" placeholder="(ex)aaa@naver.com"/></div>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<div><input name= "phone" type="text" placeholder="-없이 숫자만 입력하세요"/></div>
					</td>
				</tr>
				<tr>
					<td rowspan="3">
					...
					<td>
					<div><input name= "postcode" id= "postcode" type="text" placeholder="우편번호만입력" /></div>
					<input name= "postcode"  type="button" value="우편번호 찾기" onclick="findAddr()"/>
					</td>
				<tr>
					<td>
					<div><input name= "address1" id="address1" type="text" placeholder="주소"/></div>
					</td>
				</tr>
				<tr>
					<td>
					<div><input name= "address2" id="address2" type="text" placeholder="상세주소"/></div>
					</td>
				</tr>
			</table>
			<input type="submit" value="가입하기" onclick="check();"></div>
</form>
	</div>
